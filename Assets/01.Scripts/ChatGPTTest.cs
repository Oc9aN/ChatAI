...
public class ChatGPTTest : MonoBehaviour
{
    ...
    public async void Send()
    {
        ...
        SetChatText("User", prompt);
        SetChatText("GPT", npcResponse.ReplyMessage);
    ...
    {
        var request = new SpeechRequest(text, responseFormat: SpeechResponseFormat.PCM, voice: Voice.Nova);
